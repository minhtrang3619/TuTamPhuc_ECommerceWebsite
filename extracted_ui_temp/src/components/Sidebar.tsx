  ...
  return (
    <aside className="w-full md:w-64 shrink-0 flex flex-col gap-6 font-sans">
      ...
      <div className="mt-8 p-5 bg-[#ece0dc]/30 border border-[#d4c3be]/40 rounded-sm relative overflow-hidden text-xs text-[#5d4037] leading-relaxed">
        <h5 className="font-serif font-bold text-sm text-[#442a22] mb-1">Mặc Đẹp Để Thiền</h5>
        <p className="opacity-80">"Từng sợi sơ gai tự nhiên được thêu dệt nương bóng mộc mạc, tạo nên một nếp vải vững tâm trì định."</p>
      </div>
    </aside>
  );
}

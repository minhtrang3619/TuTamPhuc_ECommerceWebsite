            ...
            <div>
              <div className="flex justify-between items-center px-6 py-5 border-b border-[#d4c3be]/30 bg-white">
                <div className="flex items-center gap-2">
                  <span className="font-serif text-lg font-semibold uppercase text-primary tracking-wider">Túi Cân Tâm</span>
              ...
              <div className="px-6 py-4 overflow-y-auto max-h-[calc(100vh-340px)] divide-y divide-[#eeeeee]">
                {cart.length === 0 ? (
                  <div className="py-20 text-center flex flex-col items-center justify-center">
                    ...
                    <h5 className="font-serif text-sm font-semibold text-primary mb-2">Giỏ hàng của quý khách chưa có vật phẩm</h5>
                    <p className="text-xs text-on-surface-variant/80 max-w-xs leading-relaxed">
                      "Tâm dọn rỗng để đón nhận cát lành. Xin kính mời thiền hữu ghé thưởng ngoạn các nếp pháp phục của Từ Tâm Phục."
                    </p>
                    <button
                      onClick={onClose}

...
import { X, Plus, Minus, Check, ShoppingBag, Eye } from 'lucide-react';
            ...
            <div className="p-6 md:p-8 flex flex-col justify-between max-h-[480px] overflow-y-auto">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="py-3 px-4 border border-primary text-primary hover:bg-[#eeeeee]/40 font-semibold text-xs tracking-widest uppercase transition-all duration-300 flex justify-center items-center gap-2 rounded-xs cursor-pointer"

...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center md:justify-end overflow-hidden selection:bg-primary-fixed-dim selection:text-primary">
      {/* Background Imagery */}
      ...
      {/* Login Card Section */}
      <section className="relative z-10 w-full max-w-[480px] px-margin-mobile md:mr-[10%] animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="bg-white/70 backdrop-blur-md p-10 md:p-12 rounded-xl shadow-[0_32px_64px_-12px_rgba(93,64,55,0.08)] border border-white/40">
          ...
          {/* Form Title */}
          <div className="mb-8">
            <h2 className="font-headline-md text-headline-md text-on-surface mb-2">Đăng nhập</h2>
            <p className="font-body-md text-body-md text-on-surface-variant">Chào mừng bạn trở lại với không gian tịnh thức.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="relative group">
                <label className="font-caption text-caption text-on-surface-variant block mb-1 group-focus-within:text-primary transition-colors">Email của bạn</label>
                <input 
                  {...register('email')}
                  type="email" 
                  placeholder="email@example.com" 
                  className="w-full border-0 border-b border-outline-variant bg-transparent px-0 font-body-md text-body-md placeholder-outline-variant/50 transition-all duration-300 focus:border-primary focus:ring-0"
                />
                {errors.email && (
